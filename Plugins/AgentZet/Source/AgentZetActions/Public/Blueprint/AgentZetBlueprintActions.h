 ...
 */
class AGENTZETACTIONS_API FAgentZetBlueprintActions : public IAgentZetActionExecutor
{
public:
	FAgentZetBlueprintActions();
	virtual ~FAgentZetBlueprintActions();
...
private:
	...
	FAgentZetActionResult ExecuteCreateBlueprint(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);

	/** Add a component to an existing Blueprint via the Simple Construction Script. */
	FAgentZetActionResult ExecuteAddComponent(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);

	/** Add a typed member variable to a Blueprint. */
	FAgentZetActionResult ExecuteAddVariable(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);

	/** Compile a Blueprint and return all errors/warnings. */
	FAgentZetActionResult ExecuteCompileBlueprint(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);

	/** Set default property values on a Blueprint's Class Default Object. */
	FAgentZetActionResult ExecuteSetDefaults(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteInjectNodesT3D(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteAddFunction(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteSetComponentProperties(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 *   - asset_path (string, required): Content path of the Blueprint
	 */
	FAgentZetActionResult ExecuteGetBlueprintInfo(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteAddEventHandler(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteConnectPins(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteAddEnhancedInputNode(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteVerifyConnections(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	FAgentZetActionResult ExecuteSetNodePinDefault(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 *   - graph_name (string, optional): Target graph. Default: "EventGraph".
	 */
	FAgentZetActionResult ExecuteDeleteNodes(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
	 ...
	 */
	static bool CompileAndReport(UBlueprint* Blueprint, FAgentZetActionResult& Result, bool bSkipGC = true);
