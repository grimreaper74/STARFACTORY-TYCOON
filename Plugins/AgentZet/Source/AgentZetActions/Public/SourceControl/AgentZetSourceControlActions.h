...
class AGENTZETACTIONS_API FAgentZetSourceControlActions : public IAgentZetActionExecutor
{
public:
    FAgentZetSourceControlActions();
    virtual ~FAgentZetSourceControlActions();
