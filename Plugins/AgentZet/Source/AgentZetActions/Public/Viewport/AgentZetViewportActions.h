 ...
 */
class AGENTZETACTIONS_API FAgentZetViewportActions : public IAgentZetActionExecutor
{
public:
	FAgentZetViewportActions();
	virtual ~FAgentZetViewportActions();
...
private:
	 ...
	 */
	FAgentZetActionResult ExecuteCaptureViewport(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result);
