...
FAgentZetWidgetActions::FAgentZetWidgetActions() {}
FAgentZetWidgetActions::~FAgentZetWidgetActions() {}

FName FAgentZetWidgetActions::GetActionName() const { return FName(TEXT("Widget")); }
FText FAgentZetWidgetActions::GetDisplayName() const { return FText::FromString(TEXT("Widget Actions")); }
EAgentZetActionCategory FAgentZetWidgetActions::GetCategory() const { return EAgentZetActionCategory::Blueprint; }
EAgentZetRiskLevel FAgentZetWidgetActions::GetDefaultRiskLevel() const { return EAgentZetRiskLevel::Medium; }
bool FAgentZetWidgetActions::CanUndo() const { return true; }
bool FAgentZetWidgetActions::UndoAction() { return false; }

TArray<FString> FAgentZetWidgetActions::GetSupportedToolNames() const
{
	return {
...
bool FAgentZetWidgetActions::ValidateParams(const TSharedRef<FJsonObject>& Params, TArray<FString>& OutErrors) const
{
...
FAgentZetActionPlan FAgentZetWidgetActions::PreviewAction(const TSharedRef<FJsonObject>& Params)
{
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteAction(const TSharedRef<FJsonObject>& Params)
{
	FScopedTransaction Transaction(FText::FromString(TEXT("AgentZet Widget Action")));
...
UClass* FAgentZetWidgetActions::ResolveWidgetClass(const FString& ClassName)
{
	// Panel widgets
...
UWidgetBlueprint* FAgentZetWidgetActions::LoadWidgetBP(const FString& AssetPath, FAgentZetActionResult& Result)
{
...
UWidget* FAgentZetWidgetActions::FindWidgetByName(UWidgetBlueprint* WidgetBP, const FString& WidgetName, FAgentZetActionResult& Result)
{
...
bool FAgentZetWidgetActions::ParseVector2D(const FString& Str, FVector2D& OutVec)
{
...
bool FAgentZetWidgetActions::ParseMargin(const FString& Str, FMargin& OutMargin)
{
	TArray<FString> Parts;
	Str.ParseIntoArray(Parts, TEXT(","));
	if (Parts.Num() >= 4)
...
EHorizontalAlignment FAgentZetWidgetActions::ParseHAlign(const FString& Str)
{
...
EVerticalAlignment FAgentZetWidgetActions::ParseVAlign(const FString& Str)
{
...
bool FAgentZetWidgetActions::ParseLinearColor(const FString& Str, FLinearColor& OutColor)
{
...
void FAgentZetWidgetActions::CompileAndMarkDirty(UWidgetBlueprint* WidgetBP)
{
...
FString FAgentZetWidgetActions::BuildWidgetTreeJson(UWidgetBlueprint* WidgetBlueprint)
{
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteCreateWidgetBlueprint(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	...
	if (NewWidget->WidgetTree && !RootWidgetClassName.IsEmpty() && RootWidgetClassName != TEXT("none"))
	{
		...
		if (RootClass)
		{
			...
			if (RootWidget)
			{
				...
				UE_LOG(LogAgentZet, Log, TEXT("WidgetActions: Set root widget '%s' on '%s'"), *RootWidgetClassName, *AssetName);
			}
		}
		else
		{
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteAddWidget(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath      = Params->GetStringField(TEXT("asset_path"));
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteSetWidgetSlot(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	FString WidgetName = Params->GetStringField(TEXT("widget_name"));
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteSetWidgetProperty(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath     = Params->GetStringField(TEXT("asset_path"));
	FString WidgetName    = Params->GetStringField(TEXT("widget_name"));
	...
	UE_LOG(LogAgentZet, Log, TEXT("WidgetActions: Set property '%s' = '%s' on widget '%s'"), *PropertyName, *PropertyValue, *WidgetName);
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteSetWidgetFont(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	FString WidgetName = Params->GetStringField(TEXT("widget_name"));
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteSetWidgetBrush(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath   = Params->GetStringField(TEXT("asset_path"));
	FString WidgetName  = Params->GetStringField(TEXT("widget_name"));
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteBindWidgetEvent(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	FString WidgetName = Params->GetStringField(TEXT("widget_name"));
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteRemoveWidget(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath  = Params->GetStringField(TEXT("asset_path"));
	FString WidgetName = Params->GetStringField(TEXT("widget_name"));
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteGetWidgetTree(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
...
FAgentZetActionResult FAgentZetWidgetActions::ExecuteCompileWidgetBlueprint(const TSharedRef<FJsonObject>& Params, FAgentZetActionResult& Result)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
