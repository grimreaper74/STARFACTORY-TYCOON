 ...
 */
class AGENTZETUI_API SAgentZetMessage : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SAgentZetMessage) : _ShowRoleLabel(true) {}
		SLATE_ARGUMENT(FAgentZetMessage, Message)
	...
	const FAgentZetMessage& GetMessageData() const { return MessageData; }
