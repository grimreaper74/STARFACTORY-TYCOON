...
void SAgentZetInputArea::Construct(const FArguments& InArgs)
{
			...
			[
				...
				[
					...
					[
						...
						.OnTextChanged(this, &SAgentZetInputArea::OnTextChanged)
						.OnKeyDownHandler(this, &SAgentZetInputArea::OnKeyDown)
					]
				]
			]
				...
				[
					...
					[
						...
						[
							...
							.OnClicked(FOnClicked::CreateSP(this, &SAgentZetInputArea::OnSendClicked))
						...
						[
							...
							.OnClicked(FOnClicked::CreateSP(this, &SAgentZetInputArea::OnStopClicked))
...
void SAgentZetInputArea::ClearInput()
{
...
void SAgentZetInputArea::FocusInput()
{
	if (InputTextBox.IsValid())
	{
...
void SAgentZetInputArea::SetSendEnabled(bool bEnabled)
{
	bSendEnabled = bEnabled;
}

void SAgentZetInputArea::SetConversationState(EConversationState NewState)
{
...
void SAgentZetInputArea::SetQueuedMessageCount(int32 Count)
{
	QueuedCount = Count;
...
void SAgentZetInputArea::SetMentionSuggestions(const TArray<FString>& Suggestions)
{
	MentionSuggestions = Suggestions;
}

void SAgentZetInputArea::SetSlashCommandSuggestions(const TArray<FString>& Commands)
{
	SlashSuggestions = Commands;
}

void SAgentZetInputArea::InsertText(const FString& Text)
{
...
FString SAgentZetInputArea::GetCurrentText() const
{
...
TSharedRef<SWidget> SAgentZetInputArea::BuildAutocompletePopup()
{
	return SNew(SBorder)
...
TSharedRef<SWidget> SAgentZetInputArea::BuildQueueBadge()
{
...
TSharedRef<SWidget> SAgentZetInputArea::BuildAutoApproveToggle()
{
	return SNew(SComboButton)
		.ButtonContent()
		[
			SNew(STextBlock)
			.Text(this, &SAgentZetInputArea::GetAutoApproveLabel)
			.Font(FCoreStyle::GetDefaultFontStyle("Regular", 8))
		]
		.MenuContent()
		[
...
TSharedRef<SWidget> SAgentZetInputArea::MakeAutoApproveMenu()
{
	...
	MenuBuilder.AddMenuEntry(
		...
		{
			if (UAgentZetDeveloperSettings* Settings = GetMutableDefault<UAgentZetDeveloperSettings>())
			{
...
FText SAgentZetInputArea::GetAutoApproveLabel() const
{
...
FReply SAgentZetInputArea::OnSendClicked()
{
	SubmitPrompt();
	return FReply::Handled();
}

FReply SAgentZetInputArea::OnStopClicked()
{
	OnStopRequested.ExecuteIfBound();
	return FReply::Handled();
}

void SAgentZetInputArea::SubmitPrompt()
{
...
void SAgentZetInputArea::OnTextChanged(const FText& NewText)
{
...
FReply SAgentZetInputArea::OnKeyDown(const FGeometry& MyGeometry, const FKeyEvent& KeyEvent)
{
...
void SAgentZetInputArea::ShowMentionPopup(const FString& PartialText)
{
...
void SAgentZetInputArea::ShowSlashPopup(const FString& PartialText)
{
...
void SAgentZetInputArea::HideAutocompletePopup()
{
	bShowMentionPopup = false;
	bShowSlashPopup = false;
...
void SAgentZetInputArea::SelectPopupItem(int32 Index)
{
	const TArray<FString>& Items = bShowSlashPopup ? SlashSuggestions : MentionSuggestions;
...
FString SAgentZetInputArea::GetCurrentPartialToken() const
{
