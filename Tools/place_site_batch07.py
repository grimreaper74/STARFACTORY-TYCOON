"""Site batch 07: import and place the authored gate nodes and the
substation - the automated gate node at both fence openings and the
substation/battery farm east of paint. Idempotent via LB.Site07.
...
TAG = "LB.Site07"
OUT = "C:/Temp/lb_site07.json"

MODELS = [
    ("Site/GateNode_v001", "SM_LB_Site_GateNode_v001"),
    ("Site/Substation_v001", "SM_LB_Site_Substation_v001"),
]
...
place("SM_LB_Site_GateNode_v001", 37000.0, 15200.0, 0.0, "Site_MainGateNode")
place("SM_LB_Site_GateNode_v001", -37000.0, 500.0, 0.0, "Site_WestGateNode")
place("SM_LB_Site_Substation_v001", 30500.0, -8500.0, 0.0, "Site_Substation")

LEVEL_SUB.save_current_level()
REPORT["total"] = sum(REPORT["placed"].values())
with io.open(OUT, "w", encoding="utf-8") as handle:
    handle.write(json.dumps(REPORT, indent=1, sort_keys=True))
unreal.log("LINE_BOSS_SITE07 {}".format(json.dumps(REPORT, sort_keys=True)))
