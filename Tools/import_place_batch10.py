"""Batch 10: andon boards over the line entries, shield carts at underbody.

Idempotent via LB.Batch10. Run with -ExecutePythonScript.
"""
import io
import json
import os
...
TAG = "LB.Batch10"
OUT = os.environ.get("LB_BATCH_OUT", "C:/Temp/lb_batch10.json")

MODELS = [
    ("AssemblyShop/AndonBoard_v001", "SM_LB_Assembly_AndonBoard_v001"),
    ("AssemblyShop/ShieldCart_v001", "SM_LB_Assembly_ShieldCart_v001"),
]
...
place("SM_LB_Assembly_AndonBoard_v001", 3000.0, 5500.0, 90.0,
      "Asm_Andon_TrimEntry")
place("SM_LB_Assembly_AndonBoard_v001", 25500.0, 11500.0, 90.0,
      "Asm_Andon_FinalEntry")
place("SM_LB_Assembly_AndonBoard_v001", -2600.0, -7000.0, 90.0,
      "Weld_Andon_RunA")
for n, (cx, yaw) in enumerate(((28000.0, 0.0), (27400.0, 180.0),
                               (26200.0, 0.0), (25600.0, 180.0))):
    place("SM_LB_Assembly_ShieldCart_v001", cx, 10800.0, yaw,
          "Asm_ShieldCart_{:d}".format(n))
...
unreal.log("LINE_BOSS_BATCH10 {}".format(json.dumps(REPORT, sort_keys=True)))
