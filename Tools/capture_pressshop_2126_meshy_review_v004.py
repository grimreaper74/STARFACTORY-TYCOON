...
ROOT = Path(unreal.Paths.project_saved_dir()) / "ValidationScreenshots" / "PressShop2126" / "MeshyCandidate_v050"
RECEIPT = ROOT / "pressshop_2126_meshy_review_v050.json"
SHOTS = (
    ...
    ("CAM | 2126 outbound autonomy", "04_outbound_autonomy.png"),
)
SIZE = (1920, 1080)
MIN_BYTES = 4096
...
def finish(status):
    ...
    unreal.log("PRESSSHOP_2126_MESHY_REVIEW_V014_" + status)
