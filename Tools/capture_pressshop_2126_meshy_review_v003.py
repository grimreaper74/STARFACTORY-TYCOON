...
ROOT = Path(unreal.Paths.project_saved_dir()) / "ValidationScreenshots" / "PressShop2126" / "MeshyCandidate_v003"
RECEIPT = ROOT / "pressshop_2126_meshy_review_v003.json"
SHOTS = (
...
def finish(status):
    ...
    unreal.log("PRESSSHOP_2126_MESHY_REVIEW_V003_" + status)
