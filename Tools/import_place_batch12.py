"""Batch 12: flash-off modules after the topcoat booths, sealer decks before.

Idempotent via LB.Batch12. Run with -ExecutePythonScript.
"""
import io
import json
import os
...
TAG = "LB.Batch12"
OUT = os.environ.get("LB_BATCH_OUT", "C:/Temp/lb_batch12.json")

MODELS = [
    ("PaintShop/FlashOff_v001", "SM_LB_Paint_FlashOffTunnel_v001"),
    ("PaintShop/SealerDeck_v001", "SM_LB_Paint_SealerDeck_v001"),
]
...
for n in range(2):
    place("SM_LB_Paint_FlashOffTunnel_v001", 19900.0 + n * 600.0, -8500.0,
          0.0, "Paint_FlashOff_{:d}".format(n))
place("SM_LB_Paint_SealerDeck_v001", 13300.0, -9300.0, 0.0,
      "Paint_SealerDeck_S")
place("SM_LB_Paint_SealerDeck_v001", 13300.0, -7700.0, 180.0,
      "Paint_SealerDeck_N")
...
unreal.log("LINE_BOSS_BATCH12 {}".format(json.dumps(REPORT, sort_keys=True)))
