"""Batch 08: respot fixtures, wheel carousel and flash gantries.

Respot fixtures take the open line positions behind each framing gate;
the carousel feeds station 17; the flash gantries straddle stations 19
and 20. Idempotent via LB.Batch08. Run with -ExecutePythonScript.
"""
import io
import json
import os
...
TAG = "LB.Batch08"
OUT = os.environ.get("LB_BATCH_OUT", "C:/Temp/lb_batch08.json")

MODELS = [
    ("WeldShop/RespotFixture_v001", "SM_LB_Weld_RespotFixture_v001"),
    ("AssemblyShop/WheelCarousel_v001", "SM_LB_Assembly_WheelCarousel_v001"),
    ("AssemblyShop/FlashGantry_v001", "SM_LB_Assembly_FlashGantry_v001"),
]
...
place("SM_LB_Weld_RespotFixture_v001", -10050.0, -7000.0, 0.0,
      "Weld_RespotFixture_A")
place("SM_LB_Weld_RespotFixture_v001", -12050.0, -11200.0, 0.0,
      "Weld_RespotFixture_B")
place("SM_LB_Assembly_WheelCarousel_v001", 19400.0, 12300.0, 180.0,
      "Asm_WheelCarousel_S17")
place("SM_LB_Assembly_FlashGantry_v001", 15000.0, 11500.0, 0.0,
      "Asm_FlashGantry_S19")
place("SM_LB_Assembly_FlashGantry_v001", 12800.0, 11500.0, 0.0,
      "Asm_FlashGantry_S20")
...
unreal.log("LINE_BOSS_BATCH08 {}".format(json.dumps(REPORT, sort_keys=True)))
