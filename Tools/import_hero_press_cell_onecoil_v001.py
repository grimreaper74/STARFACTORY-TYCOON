"""Import only the prepared one-coil hero press into a candidate Content folder.
...
SOURCE = PROJECT / "SourceAssets" / "Candidate" / "PressShop" / "HeroPressCell_MeshyOneCoil_v001"
FBX = SOURCE / "Runtime" / "SM_LB_PS_HeroPressCell_MeshyOneCoil_v001.fbx"
TEXTURES = {
    "BaseColor": SOURCE / "Textures" / "T_LB_PS_HeroPressCell_MeshyOneCoil_BaseColor_v001.png",
    "MetallicRoughness": SOURCE / "Textures" / "T_LB_PS_HeroPressCell_MeshyOneCoil_MetallicRoughness_v001.png",
    "Normal": SOURCE / "Textures" / "T_LB_PS_HeroPressCell_MeshyOneCoil_Normal_v001.png",
}
DESTINATION = "/Game/LineBoss/Candidates/PressShop/HeroPressCell_MeshyOneCoil_v001"
TEXTURE_DESTINATION = DESTINATION + "/Textures"
MATERIAL_DESTINATION = DESTINATION + "/Materials"
MESH_NAME = "SM_LB_PS_HeroPressCell_MeshyOneCoil_v001"
MASTER_NAME = "M_LB_PS_HeroPressCell_MeshyOneCoil_v001"
INSTANCE_NAME = "MI_LB_PS_HeroPressCell_MeshyOneCoil_v001"
RECEIPT = PROJECT / "Saved" / "Audits" / "PressShopIntegration" / "hero_press_cell_onecoil_unreal_import_v001.json"
...
try:
    ...
    pass
if triangles is not None and triangles != 14737:
    fail("imported LOD0 triangle count {} differs from 14,737 source triangles".format(triangles))
