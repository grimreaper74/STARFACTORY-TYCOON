...
OUT=ROOT/r'Saved\ValidationScreenshots\PressShopIntegration\pr009_pr010_foundation_transient_v899';AUDIT=ROOT/r'Saved\Audits\PressShopIntegration\pr009_pr010_foundation_transient_capture_v899.json'
VIEWS=[
 ('01_PR009_Hero_v899.png',(-700,-1800,750),(0,0,180),60.0),
 ('02_PR010_Hero_v899.png',(2500,-2600,900),(1600,0,150),64.0),
]
...
for station,loc in {'PR009':(0,0,0),'PR010':(1600,0,0)}.items():
...
floor=actors.spawn_actor_from_class(unreal.StaticMeshActor,unreal.Vector(800,0,-12),unreal.Rotator());floor.static_mesh_component.set_static_mesh(cube);floor.set_actor_scale3d(unreal.Vector(22,22,.1));floor.static_mesh_component.set_cast_shadow(False)
sun=actors.spawn_actor_from_class(unreal.DirectionalLight,unreal.Vector(800,0,1000),unreal.Rotator(pitch=-42,yaw=-35,roll=0));sun.light_component.set_editor_property('intensity',2.5)
sky=actors.spawn_actor_from_class(unreal.SkyLight,unreal.Vector(800,0,500),unreal.Rotator());cube_map=unreal.EditorAssetLibrary.load_asset('/Engine/EngineSky/DefaultTextureCube.DefaultTextureCube')
...
for loc,intensity,radius in [((-300,-800,750),3500,2200),((1900,-900,750),4000,2400),((800,800,600),2500,2200)]:
