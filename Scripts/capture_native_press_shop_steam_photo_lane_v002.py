...
OUTPUT = ROOT / "Saved/ValidationScreenshots/OneFactory/NativePressShopSteamPhotoLane_v002"
RECEIPT = OUTPUT / "press_shop_steam_photo_lane_v002.json"
    ...
    try:
        ...
        if phase == "wait_screenshot":
            ...
            if shot_index < len(SHOTS):
                ...
                return
            finish({
                "$schema": "lineboss/evidence/onefactory/native-press-steam-photo-lane-v002/v1",
