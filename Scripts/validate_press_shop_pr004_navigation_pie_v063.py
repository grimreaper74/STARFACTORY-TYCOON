"""Run the proven navigation gate against PR-008 Pro entry-loop v063."""
import os
from pathlib import Path
base = Path(__file__).with_name("validate_press_shop_pr004_navigation_pie_v026.py")
...
os.environ["LB_PR004_COLLISION_CANDIDATE"] = "v063"
