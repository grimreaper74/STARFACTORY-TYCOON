...
import unreal
MAP="/Game/LineBoss/Developer/Validation/LB_InboundCoilDeliveryReview_v497";DEST="/Game/LineBoss/IndustrialKit/InboundCoilDelivery/Candidate_v003";BRIDGE="/Game/LineBoss/IndustrialKit/MaterialHandling/BridgeCrane"
...
if not levels.new_level(MAP):raise RuntimeError("Could not create v497")
...
cam=actors.spawn_actor_from_class(unreal.CameraActor,unreal.Vector(2200,-2500,1350),unreal.Rotator());cam.set_actor_label("LB_CAM_InboundCoilDelivery_v497");cam.set_actor_rotation(unreal.MathLibrary.find_look_at_rotation(cam.get_actor_location(),unreal.Vector(20,150,190)),False);cam.camera_component.set_editor_properties({"field_of_view":54.0,"aspect_ratio":16/9,"constrain_aspect_ratio":True});cam.tags=[unreal.Name("LB.Camera.Fixed"),unreal.Name("LB.Asset.ValidationOnly")]
unreal.AutomationUtilsBlueprintLibrary.finish_all_asset_compilation()
if not levels.save_current_level():raise RuntimeError("Failed saving v497")
unreal.log("LINE_BOSS_INBOUND_REVIEW_V497_BUILD_PASS")
