...
OUTPUT = PROJECT / "Scripts/body_shop_support_kit_native_unreal_import_baseline_v001.json"
...
PROTECTED_GROUPS = (
    ...
    {"name": "current_source_tree", "roots": ("Source",)},
    {"name": "current_config_tree", "roots": ("Config",)},
    {
...
def fail(message: str) -> None:
    raise RuntimeError("BODYSHOP_SUPPORT_KIT_NATIVE_BASELINE_V001_FAIL: " + message)
...
def asset_contract(manifest: dict, geometry: dict, frozen: dict[str, dict]) -> dict:
    ...
    for key in ASSET_KEYS:
        ...
        for lod_index, lod_key in enumerate(("LOD0", "LOD1", "LOD2")):
            ...
            if abs(float(source["bounds"]["minimum_m"][2])) > 0.00001:
            ...
            lod_rows.append({
                ...
                "source_bounds_m": source["bounds"],
                "expected_unreal_bounds": expected_unreal_bounds(source["bounds"]),
        ...
        output[key] = {
            ...
            "target_dimensions_m": [float(value) for value in spec["dimensions_m"]],
...
def build_payload() -> dict:
    ...
    return {
        "$schema": "lineboss/bodyshop-support-kit-native-v001-unreal-import-baseline/v1",
        "generated_utc": datetime.now(timezone.utc).isoformat(),
        "status": "FROZEN__BODYSHOP_SUPPORT_KIT_NATIVE_V001_UNREAL_IMPORT_BASELINE",
        "project": {
            "root": str(PROJECT),
...
def main() -> None:
    ...
    if args.verify_existing:
        ...
        print("PASS__BODYSHOP_SUPPORT_KIT_NATIVE_V001_EXISTING_BASELINE_MATCHES_SOURCE_AND_PROTECTED_FILES")
