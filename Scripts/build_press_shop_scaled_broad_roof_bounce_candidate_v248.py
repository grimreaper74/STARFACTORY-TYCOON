"""Scale broad movable roof-bounce intensity appropriately in a fresh v242 child."""
...
MAP = "/Game/LineBoss/Maps/LB_PressShop_PlayableManagementCandidate_v248"
OUT = ROOT / "Saved/Audits/PressShopIntegration/press_shop_scaled_broad_roof_bounce_build_v248.json"
BASE_FILE = ROOT / "Content/LineBoss/Maps/LB_PressShop_PlayableManagementCandidate_v242.umap"
MAP_FILE = ROOT / "Content/LineBoss/Maps/LB_PressShop_PlayableManagementCandidate_v248.umap"
...
for bay_id, x_value in enumerate((2600.0, 5600.0, 8600.0), 1):
    ...
    if light is None:
        ...
        continue
    label = f"LB_WHOLE_V248_SCALED_BROAD_ROOF_BOUNCE_{bay_id:02d}"
    ...
    light.tags = [
        ...
        unreal.Name("LB.VisualCorrection.RoofReadability.v248"),
...
if len(added) != 3:
    failures.append(f"expected three scaled broad roof-bounce lights, added {len(added)}")
if not levels.save_current_level():
    failures.append("could not save v248")
parent_hash_after = sha256(BASE_FILE)
if parent_hash_after != parent_hash_before:
    failures.append("protected v242 parent changed")

payload = {
    "$schema": "cairnwell/audit/press-shop-scaled-broad-roof-bounce-build-v248/v1",
    "generated_utc": datetime.now(timezone.utc).isoformat(),
    "status": "PASS__SCALED_BROAD_MOVABLE_ROOF_BOUNCE_ADDED_DIRECTLY_FROM_V242__FRESH_VISUAL_AND_RUNTIME_GATES_REQUIRED__NOT_PROMOTED" if not failures else "FAIL__NOT_PROMOTED",
    "base": BASE,
    "map": MAP,
    ...
    "added_lights": added,
    "rejected_maps_not_in_ancestry": ["v243", "v244", "v245", "v246", "v247"],
    "contract": {
