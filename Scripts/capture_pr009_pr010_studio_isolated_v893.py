...
OUT=ROOT/r'Saved\ValidationScreenshots\PressShopIntegration\pr009_pr010_studio_isolated_v893';AUDIT=ROOT/r'Saved\Audits\PressShopIntegration\pr009_pr010_studio_isolated_capture_v893.json'
VIEWS=[
 ('01_PR009_Hero_v893.png',(-1350,-1550,700),(-650,0,170),62.0),
 ('02_PR009_Front_v893.png',(-650,-1800,300),(-650,0,170),58.0),
 ('03_PR009_Side_v893.png',(-1800,0,320),(-650,0,170),58.0),
 ('04_PR010_Hero_v893.png',(1550,-2350,850),(650,0,150),64.0),
 ('05_PR010_Front_v893.png',(650,-2600,380),(650,0,140),60.0),
 ('06_PR010_Side_v893.png',(-1300,0,350),(650,0,140),60.0),
]
levels=unreal.get_editor_subsystem(unreal.LevelEditorSubsystem);actors=unreal.get_editor_subsystem(unreal.EditorActorSubsystem)
if not levels.load_level(MAP):raise RuntimeError(MAP)
targets={'LB_PR009_OriginalHighPoly_v892','LB_PR010_OriginalHighPoly_v892'};found=[]
for a in actors.get_all_level_actors():
 if a.get_actor_label() in targets:
  found.append(a.get_actor_label());a.set_actor_hidden_in_game(False)
  if isinstance(a,unreal.StaticMeshActor):a.static_mesh_component.set_editor_property('visible',True);a.static_mesh_component.set_editor_property('hidden_in_game',False)
 else:a.set_actor_hidden_in_game(True)
if set(found)!=targets:raise RuntimeError(f'missing studio targets {found}')
