...
source_dir = root / "SourceAssets/Candidate/Spacecraft/Buildings_v004"
manifest_path = source_dir / "spacecraft_buildings_manifest_v004.json"
dest = "/Game/LineBoss/Candidates/Spacecraft/StationMeshes_v001/Meshes"
out = root / "Saved/Audits/Spacecraft/spacecraft_buildings_import_v004.json"
...
if out.exists():
    raise RuntimeError(
        "Refusing to rerun: a receipt for v004 already exists. Author v005.")
...
report = {
    "$schema": "lineboss/audit/spacecraft-buildings-import-v004/v1",
