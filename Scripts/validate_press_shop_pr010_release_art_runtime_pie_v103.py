"""v103 exact-map adapter for retained PR-010 runtime/collision/save authority proof."""
...
code = code.replace("Saved/Audits/PR010_CollisionNavigation/runtime_collision_pie_audit_v099.json", "Saved/Audits/PR010_ReleaseArt_v103/runtime_collision_pie_audit_v103.json")
code = code.replace("pr010-runtime-collision-pie-v099", "pr010-release-art-runtime-collision-pie-v103")
