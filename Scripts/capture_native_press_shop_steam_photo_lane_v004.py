...
OUTPUT = ROOT / "Saved/ValidationScreenshots/OneFactory/NativePressShopSteamPhotoLane_v004"
RECEIPT = OUTPUT / "press_shop_steam_photo_lane_v004.json"
    ...
    try:
        ...
        if phase == "wait_screenshot":
            ...
            if shot_index < len(SHOTS):
                ...
                return
            finish({
                "$schema": "lineboss/evidence/onefactory/native-press-steam-photo-lane-v004/v1",
