...
source_dir = root / "SourceAssets/Candidate/Spacecraft/Buildings_v003"
manifest_path = source_dir / "spacecraft_buildings_manifest_v003.json"
dest = "/Game/LineBoss/Candidates/Spacecraft/StationMeshes_v001/Meshes"
out = root / "Saved/Audits/Spacecraft/spacecraft_buildings_import_v003.json"
...
if out.exists():
    raise RuntimeError(
        "Refusing to rerun: a receipt for v003 already exists. Author v004.")
...
report = {
    "$schema": "lineboss/audit/spacecraft-buildings-import-v003/v1",
