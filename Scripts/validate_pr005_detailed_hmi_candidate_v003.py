...
def main() -> None:
    ...
    hmi.static_mesh_component.set_collision_enabled(unreal.CollisionEnabled.NO_COLLISION)`r`n    # Disposable QA actor: collision is disabled; runtime nav/overlap policy is separate.
