...
out = root / "Saved/Audits/Spacecraft/surface_master_v004.json"
if out.exists():
    raise RuntimeError("Refusing to rerun: receipt exists. Author v005.")
...
report = {
    "$schema": "lineboss/audit/surface-master-v004/v1",
