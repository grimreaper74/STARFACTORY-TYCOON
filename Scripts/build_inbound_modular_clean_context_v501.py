...
import unreal
MAP="/Game/LineBoss/Developer/Validation/LB_InboundCoilDeliveryCleanContext_v501";DEST="/Game/LineBoss/IndustrialKit/InboundCoilDelivery/Candidate_v003";BRIDGE="/Game/LineBoss/IndustrialKit/MaterialHandling/BridgeCrane"
...
if not levels.new_level(MAP):raise RuntimeError("Could not create v501")
