"""v004 fixed-camera adapter for the isolated Train A open-bay visual gate."""
...
code = code.replace("LB_PRESS_TRAIN_A_V001_CAPTURE", "LB_PRESS_TRAIN_A_V004_CAPTURE")
code = code.replace("Press Train A v001", "Press Train A v004")
code = code.replace("press_train_a_v001", "press_train_a_v004")
code = code.replace("PRESS_TRAIN_A_V001_CAPTURE", "PRESS_TRAIN_A_V004_CAPTURE")
