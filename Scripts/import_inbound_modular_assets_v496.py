"""Import/bind inbound Modular_v003 to an isolated Unreal candidate folder."""
from pathlib import Path
import hashlib,json,unreal
PROJECT=Path(unreal.Paths.project_dir());SOURCE=PROJECT/"SourceAssets/Candidate/PressShop/InboundCoilDelivery/Modular_v003/FBX";DEST="/Game/LineBoss/IndustrialKit/InboundCoilDelivery/Candidate_v003";MAT="/Game/LineBoss/IndustrialKit/InboundCoilDelivery/Candidate_v001/Materials_v001";OUT=Path(unreal.Paths.project_saved_dir())/"Audits/PressShopIntegration/inbound_modular_import_v496.json"
MODULES={
"SM_CA_MW_MOD_LorryCab_v003":((240,300),(260,340),(270,340)),"SM_CA_MW_MOD_CoilTrailer_v003":((220,300),(1000,1200),(300,450)),"SM_CA_MW_MOD_DockGuidesAndRestraint_v003":((280,380),(650,750),(50,100)),"SM_CA_MW_MOD_DockControlAndSignals_v003":((100,180),(30,100),(240,290)),"SM_CA_MW_MOD_ReceivingSaddle_v003":((240,300),(300,370),(80,130)),"SM_CA_MW_MOD_AGVHandoffGuides_v003":((220,290),(380,450),(20,60)),"SM_CA_MW_MOD_IdentityScanner_v003":((25,60),(20,50),(160,210)),"SM_CA_MW_MOD_EntranceDockEnvelope_v003":((550,650),(80,150),(450,520)),"SM_CA_MW_MOD_CraneBayStructure_v003":((650,720),(620,700),(620,680))}
...
for name,gates in MODULES.items():
 ...
 if not isinstance(mesh,unreal.StaticMesh):raise RuntimeError(f"Missing imported v003 mesh {path}")
 ...
 for index,slot in enumerate(mesh.get_editor_property("static_materials")):
  ...
  if mat is None:raise RuntimeError(f"Unknown v003 slot {slotname} on {name}")
...
OUT.parent.mkdir(parents=True,exist_ok=True);OUT.write_text(json.dumps({"candidate":"InboundCoilDelivery_Candidate_v003","parent":"Modular_v002","status":"PASS_ISOLATED_IMPORT_NOT_PROMOTED","engineering":"TBC","assets":rows},indent=2),encoding="utf-8");unreal.log("LINE_BOSS_INBOUND_IMPORT_V496_PASS "+str(OUT))
