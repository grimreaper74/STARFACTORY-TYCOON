"""v002 fixed-camera adapter for corrected isolated Press Train A."""
...
code = code.replace("LB_PRESS_TRAIN_A_V001_CAPTURE", "LB_PRESS_TRAIN_A_V002_CAPTURE")
code = code.replace("Press Train A v001", "Press Train A v002")
code = code.replace("press_train_a_v001", "press_train_a_v002")
code = code.replace("PRESS_TRAIN_A_V001_CAPTURE", "PRESS_TRAIN_A_V002_CAPTURE")
