...
out = root / "Saved/Audits/Spacecraft/surface_master_v005.json"
if out.exists():
...
mel.connect_material_expressions(height_scaled, "", height_biased, "A")
...
INSTANCES = {
    ...
    "MI_LB_Surface_PalePanel_Graded": {
        "tint": unreal.LinearColor(0.78, 0.77, 0.74, 1.0),
        "accent": unreal.LinearColor(0.30, 0.30, 0.31, 1.0),
        "wear": 0.0, "rough": 0.56, "metal": 0.03, "tiling": 300.0,
        "normal": 0.22, "HeightBlend": 0.75},
...
report = {
    "$schema": "lineboss/audit/surface-master-v005/v1",
