...
def done(_):
 ...
 if elapsed>=16 and out.exists() and out.stat().st_size>=1024:unreal.log(f"LB_V321_CAPTURE_PASS path={out}")
 elif elapsed<90:return
 else:unreal.log_error("LB_V321_CAPTURE_FAIL")
