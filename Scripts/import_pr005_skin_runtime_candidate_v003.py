...
SOURCE_ROOT = ROOT / "SourceAssets/Candidate/PressShop/PR005/SkinRuntimeCandidate_v002_UnrealTransformCorrected"
MANIFEST_PATH = SOURCE_ROOT / "PR005_SkinRuntimeCandidate_v002_UnrealTransformCorrected_manifest.json"
DESTINATION = "/Game/LineBoss/Stations/Press/PR005/Candidate_v001/ArtDerivatives/SkinRuntime_v003"
MESH_DESTINATION = DESTINATION + "/StaticMeshes"
MATERIAL_DESTINATION = DESTINATION + "/Materials"
AUDIT = ROOT / "Saved/Audits/PR005/SkinRuntime_v003/pr005_skin_runtime_intake_v003.json"
...
if manifest.get("status") != "CANDIDATE_ONLY__SOURCE_DERIVATIVE_SCALE_AND_TRANSFORM_CORRECTED__UNREAL_INTAKE_NOT_STARTED":
...
palette = {
    "M_CA_MW_PR005_Skin_WarmWhite_v001": ((0.8963, 0.8800, 0.8148), 0.48, 0.10),
    "M_CA_MW_PR005_Skin_Graphite_v001": ((0.0144, 0.0176, 0.0212), 0.42, 0.55),
    "M_CA_MW_PR005_Skin_CairnwellGreen_v001": ((0.0137, 0.0704, 0.0578), 0.45, 0.20),
    "M_CA_MW_PR005_Skin_SafetyYellow_v001": ((0.8879, 0.5457, 0.0), 0.42, 0.20),
    "M_CA_MW_PR005_Skin_ExposedSteel_v001": ((0.1620, 0.1840, 0.2010), 0.30, 0.88),
...
for export in manifest["exports"]:
    ...
    for index, static_material in enumerate(mesh.get_editor_property("static_materials")):
        ...
        material = created_materials.get(f"M_{material_name}")
        if material is None:
...
report = {
    "$schema": "cairnwell/pr005-skin-runtime-intake-v003/v1",
