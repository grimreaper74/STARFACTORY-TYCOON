"""Isolated Unreal intake for the coherent four-coil inbound lorry v001."""
...
audit = project / "Saved/Audits/PressShopIntegration/inbound_lorry_assembly_import_v528.json"
...
unreal.log("LINE_BOSS_INBOUND_LORRY_ASSEMBLY_V528_IMPORT_PASS")
