...
source_dir = root / "SourceAssets/Candidate/Spacecraft/Buildings_v002"
manifest_path = source_dir / "spacecraft_buildings_manifest_v002.json"
dest = "/Game/LineBoss/Candidates/Spacecraft/StationMeshes_v001/Meshes"
out = root / "Saved/Audits/Spacecraft/spacecraft_buildings_import_v002.json"
...
if out.exists():
    raise RuntimeError(
        "Refusing to rerun: a receipt for v002 already exists. Author v003.")
...
report = {
    "$schema": "lineboss/audit/spacecraft-buildings-import-v002/v1",
