"""Import the generated SITE SCENERY as Nanite static meshes.
...
source_dir = root / "SourceAssets/Candidate/Spacecraft/SiteScenery_Export_v001"
dest = "/Game/LineBoss/Candidates/Spacecraft/SiteScenery_v001"
out = root / "Saved/Audits/Spacecraft/site_scenery_import_v001.json"
if out.exists():
...
EXPECTED = {
    "SM_LB_SC_FencePanel": ("z", 250),
    "SM_LB_SC_EntranceGate": ("x", 1400),
    "SM_LB_SC_LightMast": ("x", 1000),
    "SM_LB_SC_CargoContainer": ("x", 600),
    "SM_LB_SC_StorageTank": ("z", 1000),
    "SM_LB_SC_Substation": ("z", 300),
    "SM_LB_SC_DeliveryHauler": ("x", 900),
}
...
report = {
    "$schema": "lineboss/audit/site-scenery-import-v001/v1",
    ...
    "not_proven": [
        ...
        "The pipe rack was NOT generated: two attempts returned a "
        "canopy and a vessel, and the project's own kit already has 54 "
        "pipe pieces. Credits are not spent on a third try for a thing "
        "we already own.",
    ],
}
