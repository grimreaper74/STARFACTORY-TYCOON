"""import_station_meshes_isolated_v005.py - the assembly bay (owner's
morning drop 2026-08-26, owner-named assembly_bay). AssemblyRobot
catalogue footprint 18 x 14 m; derivatives measured 17.0 x 13.7 x 7.4 m.
Albedo measured 0.290 linear -> boost 1.00.
...
unreal.log("ASSEMBLY BAY IMPORT DONE: 2 LODs, MI on v003 master, "
           "boost %.2f" % BOOST)
