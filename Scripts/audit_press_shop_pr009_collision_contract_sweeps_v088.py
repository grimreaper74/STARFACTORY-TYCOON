...
runtime_path = root / "Saved/Audits/PR009_InMap_v088/runtime_pie_audit.json"
build_path = root / "Saved/Audits/PR009_InMap_v088/release_collision_build.json"
out = root / "Saved/Audits/PR009_InMap_v088/collision_contract_sweep_audit.json"
...
payload = {"$schema":"cairnwell/audit/pr009-collision-contract-sweeps-v088/v1","generated_utc":datetime.now(timezone.utc).isoformat(),
