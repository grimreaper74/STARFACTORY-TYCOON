"""Run the proven support-crane gate against isolated PR-008 Pro envelope v062."""
import os
from pathlib import Path

base = Path(__file__).with_name("validate_press_shop_pr004_support_crane_pie_v036.py")
...
os.environ["LB_SUPPORT_CRANE_CANDIDATE"] = "v062"
