...
# Recoverably moves only the exact 27-file failed Body Shop v001 legacy staging
# namespace. It deliberately refuses any partial, expanded, or unexpected tree.
...
$Expected = @(
    ...
    '__LegacyLODStaging/SM_LB_BodyShopRobot_Base_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_Base_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J1_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J1_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J2_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J2_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J3_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J3_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J4_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J4_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J5_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopRobot_J5_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopTool_PanelPick8Cup_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShopTool_PanelPick8Cup_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShop_UnderbodyFixture_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShop_UnderbodyFixture_v001__LegacySourceLOD2.uasset',
    '__LegacyLODStaging/SM_LB_BodyShop_VisionGate_v001__LegacySourceLOD1.uasset',
    '__LegacyLODStaging/SM_LB_BodyShop_VisionGate_v001__LegacySourceLOD2.uasset'
)
...
try {
    ...
    $quarantine = Join-Path $RejectedRoot ('BodyShopUnderbodySlice_v001_legacy_scale100_failure_' + $stamp)
    ...
    $receipt = [ordered]@{
        schema = 'lineboss/audit/bodyshop/experimental-v001-underbody-art-failed-legacy-staging-import-quarantine/v1'
        generated_utc = (Get-Date).ToUniversalTime().ToString('o')
        status = 'PASS__RECOVERABLY_QUARANTINED_FAILED_LEGACY_SCALE100_STAGING_IMPORT_NAMESPACE_V001'
    ...
    [ordered]@{
        schema = 'lineboss/audit/bodyshop/experimental-v001-underbody-art-failed-legacy-staging-import-quarantine-failure/v1'
        generated_utc = (Get-Date).ToUniversalTime().ToString('o')
        status = 'FAIL_CLOSED__NO_CLEANUP_PERFORMED'
        source = $Source
        error = $_.Exception.Message
    } | ConvertTo-Json -Depth 5 | Set-Content -LiteralPath (Join-Path $RejectedRoot 'bodyshop_underbody_slice_failed_legacy_staging_import_quarantine_failure_v001.json') -Encoding utf8
    throw
}
