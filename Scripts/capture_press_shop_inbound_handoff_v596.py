"""Single-shot handoff evidence capture for v596."""
...
LABEL = "LB_CAM_InboundRelease_Handoff_v596"
PATH = Path(unreal.Paths.project_saved_dir()) / "ValidationScreenshots/PressShopIntegration/inbound_release_v596/inbound_handoff_to_pr003.png"
...
def tick(_dt):
    ...
    if not PATH.exists() or PATH.stat().st_size <= 1024:
        unreal.log_error(f"LINE_BOSS_INBOUND_V596_HANDOFF_CAPTURE_FAIL {PATH}")
    else:
        unreal.log(f"LINE_BOSS_INBOUND_V596_HANDOFF_CAPTURE_PASS {PATH}")
