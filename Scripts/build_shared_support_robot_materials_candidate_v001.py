"""Build a shared, unpromoted Surface Forge-derived robot paint system.
...
MASTER_NAME = "M_LB_SupportRobot_LayeredPaint_v001"
MASTER_PATH = f"{DEST}/{MASTER_NAME}"
AUDIT = ROOT / "Saved/Audits/lb_support_robot_shared_materials_candidate_v001.json"
...
mel.connect_material_expressions(ord_sample, "R", inverse_ao, "Input")
...
mel.connect_material_expressions(paint_mask, "", inverse_paint, "Input")
...
mel.connect_material_expressions(dust_mask, "", inverse_dust, "Input")
...
unreal.log(f"LINE_BOSS_SHARED_SUPPORT_ROBOT_MATERIALS_V001_BUILT instances={len(instance_rows)} audit={AUDIT}")
