...
import unreal
MAP="/Game/LineBoss/Developer/Validation/LB_InboundCoilDeliveryOrientation_v502";DEST="/Game/LineBoss/IndustrialKit/InboundCoilDelivery/Candidate_v003";BRIDGE="/Game/LineBoss/IndustrialKit/MaterialHandling/BridgeCrane"
...
if not levels.new_level(MAP):raise RuntimeError("Could not create v502")
...
mod("LorryCab",(0,-885,152),rot=(0,180,0));mod("CoilTrailer",(0,-150,188));mod("DockGuidesAndRestraint",(0,-150,35));mod("EntranceDockEnvelope",(0,-665,244));mod("DockControlAndSignals",(-310,-500,125));mod("CraneBayStructure",(0,700,320));mod("ReceivingSaddle",(0,700,47));mod("IdentityScanner",(240,700,93));mod("AGVHandoffGuides",(420,850,18))
...
cam=actors.spawn_actor_from_class(unreal.CameraActor,unreal.Vector(-2050,-2450,1350),unreal.Rotator());cam.set_actor_label("LB_CAM_InboundCoilDelivery_Orientation_v502");cam.set_actor_rotation(unreal.MathLibrary.find_look_at_rotation(cam.get_actor_location(),unreal.Vector(0,180,200)),False);cam.camera_component.set_editor_properties({"field_of_view":55.0,"aspect_ratio":16/9,"constrain_aspect_ratio":True});cam.tags=[unreal.Name("LB.Camera.Fixed"),unreal.Name("LB.Asset.ValidationOnly")]
unreal.AutomationUtilsBlueprintLibrary.finish_all_asset_compilation()
if not levels.save_current_level():raise RuntimeError("Failed saving v502")
unreal.log("LINE_BOSS_INBOUND_ORIENTATION_V502_BUILD_PASS")
