"""Use v038's exact static gate against integrated-identity map v040."""
...
code = code.replace("press_train_a_stage_cue_facing_static_v038", "press_train_a_integrated_identity_static_v040")
code = code.replace("stage-cue-facing-static-v038", "integrated-identity-static-v040")
code = code.replace("LB.Asset.Candidate.v038", "LB.Asset.Candidate.v040")
