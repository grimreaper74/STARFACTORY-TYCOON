# v003 is a straight retry of v002's prompt, unchanged: v002 reached
# 99% progress and failed with Meshy's own "resource constraints,
# please retry" server error, no credits consumed. Not a prompt
# problem - v002's evidence (the failed receipt) stays on record.
param(
    ...
    [string]$OutputRoot = 'C:\Users\greg_\Projects\LineBossCarFactory_Unreal 5.8\SourceAssets\Candidate\Spacecraft\CargoParts_v003',
    [int]$PollSeconds = 20,
    [int]$TimeoutMinutes = 40
)
$ErrorActionPreference = 'Stop'
if ($Acknowledgement -ne 'I ACCEPT MESHY CREDIT SPEND FOR CARGO PARTS V003') {
...
@{
    '$schema'      = 'lineboss/audit/meshy-cargo-parts-v003/v1'
