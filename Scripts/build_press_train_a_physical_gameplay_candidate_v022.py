"""Fresh v022 direct from v017 with the concrete NavigationSystem module class."""
...
if needle not in code:
    raise RuntimeError("v020 navigation constructor changed; refusing v022 adapter")
