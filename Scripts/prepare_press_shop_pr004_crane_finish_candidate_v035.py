"""Duplicate the technically gated v034 map into isolated finish candidate v035."""

import unreal


BASE = "/Game/LineBoss/Maps/LB_PressShop_PR004CraneManagementCandidate_v034"
...
unreal.log(f"LINE_BOSS_PR004_CRANE_V035_PREP_PASS map={MAP}")
