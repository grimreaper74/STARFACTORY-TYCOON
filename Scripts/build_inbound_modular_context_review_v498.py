...
import unreal
MAP="/Game/LineBoss/Developer/Validation/LB_InboundCoilDeliveryContextReview_v498";DEST="/Game/LineBoss/IndustrialKit/InboundCoilDelivery/Candidate_v003";BRIDGE="/Game/LineBoss/IndustrialKit/MaterialHandling/BridgeCrane"
...
if not levels.new_level(MAP):raise RuntimeError("Could not create v498")
...
cam=actors.spawn_actor_from_class(unreal.CameraActor,unreal.Vector(1850,-2450,1120),unreal.Rotator());cam.set_actor_label("LB_CAM_InboundCoilDelivery_Context_v498");cam.set_actor_rotation(unreal.MathLibrary.find_look_at_rotation(cam.get_actor_location(),unreal.Vector(0,180,210)),False);cam.camera_component.set_editor_properties({"field_of_view":56.0,"aspect_ratio":16/9,"constrain_aspect_ratio":True});cam.tags=[unreal.Name("LB.Camera.Fixed"),unreal.Name("LB.Asset.ValidationOnly")]
unreal.AutomationUtilsBlueprintLibrary.finish_all_asset_compilation()
if not levels.save_current_level():raise RuntimeError("Failed saving v498")
unreal.log("LINE_BOSS_INBOUND_CONTEXT_REVIEW_V498_BUILD_PASS")
