"""Capture one v309 roll/X axis test."""
import os,time
from pathlib import Path
import unreal
unreal.EditorPythonScripting.set_keep_python_script_alive(True)
MAP="/Game/LineBoss/Maps/LB_PressTrainA_AxisCorrectedStudioCandidate_v309";CAP={"operator":("LB_V309_CAM_Operator","v309_train_a_operator.png"),"rear":("LB_V309_CAM_Rear","v309_train_a_rear.png"),"elevated":("LB_V309_CAM_Elevated","v309_train_a_elevated.png")};cid=os.environ.get("LB_V309_CAPTURE","operator").lower();label,name=CAP[cid];out=Path(unreal.Paths.project_saved_dir())/"ValidationScreenshots/PressShopIntegration/v309_train_a_axis_corrected"/name
