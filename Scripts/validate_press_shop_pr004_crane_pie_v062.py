"""Run the proven primary-crane gate against isolated PR-008 Pro envelope v062."""
import os
from pathlib import Path

base = Path(__file__).with_name("validate_press_shop_pr004_crane_pie_v027.py")
...
os.environ["LB_PR004_CRANE_CANDIDATE"] = "v062"
