"""Prepare isolated v112 from retained support-hoist v109."""
...
MAP = "/Game/LineBoss/Maps/LB_PressShop_PR004SupportIdentityCandidate_v112"
OUT = Path(unreal.Paths.project_saved_dir()) / "Audits/press_shop_pr004_support_identity_prepare_v112.json"
...
OUT.write_text(json.dumps({
    "$schema": "cairnwell/audit/press-shop-pr004-support-identity-prepare-v112/v1",
...
unreal.log(f"CAIRNWELL_PR004_SUPPORT_IDENTITY_V112_PREPARE_PASS created={created}")
