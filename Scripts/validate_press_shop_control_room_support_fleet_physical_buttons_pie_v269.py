"""Run the v269 fleet cycle through the operations console's physical hit targets."""
...
code = code.replace(
    "Audits/ControlRoom/control_room_support_fleet_pie_v269.json",
    "Audits/ControlRoom/control_room_support_fleet_physical_buttons_pie_v269.json")
code = code.replace(
    "cairnwell/audit/control-room-support-fleet-pie-v269/v1",
    "cairnwell/audit/control-room-support-fleet-physical-buttons-pie-v269/v1")
...
code = code.replace(
    "CONTROL_ROOM_SUPPORT_FLEET_V269_DISPATCH_RECALL_AND_SELECTION_PASS__NOT_PROMOTED",
    "CONTROL_ROOM_SUPPORT_FLEET_V269_PHYSICAL_BUTTON_DISPATCH_RECALL_AND_SELECTION_PASS__NOT_PROMOTED")
code = code.replace("LINE_BOSS_CONTROL_ROOM_SUPPORT_FLEET_V269", "LINE_BOSS_CONTROL_ROOM_SUPPORT_FLEET_PHYSICAL_V269")
exec(compile(code, str(source) + "::physical-buttons", "exec"), globals(), globals())
