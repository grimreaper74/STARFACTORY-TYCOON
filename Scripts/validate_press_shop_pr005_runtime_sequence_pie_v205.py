"""Exact v205 PR005 commissioning, interlock, fault and restore wrapper."""

from pathlib import Path
source = Path(__file__).with_name("validate_press_shop_pr005_runtime_sequence_pie_v198.py")
