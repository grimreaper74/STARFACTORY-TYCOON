"""import_track_pieces_v001.py - the PROCEDURAL conveyor track piece set
...
JOBS = [("SM_LB_Track_Straight", 400.0, 340.0),
        ("SM_LB_Track_Turn", 370.0, 370.0),
        ("SM_LB_Track_Cap", 80.0, 340.0)]
