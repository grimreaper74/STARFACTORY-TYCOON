"""Read-only, fresh-process validation of native support-kit v002 Unreal packages.
...
BASELINE = PROJECT / "Scripts/body_shop_support_kit_native_unreal_import_baseline_v003.json"
EXPECTED_BASELINE_SHA256 = "A124CE80D77717C062CFFE5AFDD5058905957D29B8A8BB01979A4567149653A6"
EXPECTED_BASELINE_STATUS = "FROZEN__BODYSHOP_SUPPORT_KIT_NATIVE_V002_UNREAL_IMPORT_BASELINE_V003"
DEST = "/Game/LineBoss/Candidates/WeldShop/BodyShopSupportKitNative_v002"
DEST_DISK = PROJECT / "Content/LineBoss/Candidates/WeldShop/BodyShopSupportKitNative_v002"
AUDIT_ROOT = PROJECT / "Saved/Audits/BodyShop/SupportKitNative_v002/UnrealImportLane_v003"
RUN_ROOT_ENV = "LINEBOSS_BS_SUPPORT_KIT_NATIVE_V003_RUN_ROOT"
ACK_ENV = "LINEBOSS_BS_SUPPORT_KIT_NATIVE_V003_ACK"
ACK_TOKEN = "IMPORT_FROZEN_BODYSHOP_SUPPORT_KIT_NATIVE_V002_BASELINE_V003_ONCE"
IMPORT_RECEIPT_NAME = "import_receipt_v003.json"
IMPORT_FAILURE_NAME = "import_failure_v003.json"
VALIDATION_RECEIPT_NAME = "fresh_load_validation_receipt_v003.json"
VALIDATION_FAILURE_NAME = "fresh_load_validation_failure_v003.json"
EXPECTED_IMPORT_STATUS = (
    "PASS__HASH_GUARDED_FROZEN_BODYSHOP_SUPPORT_KIT_NATIVE_V002_BASELINE_V003_UNREAL_INTAKE"
)
...
def fail(message: str) -> None:
    raise RuntimeError("BODYSHOP_SUPPORT_KIT_NATIVE_FRESH_VALIDATION_LANE_V003_FAIL: " + message)
...
def load_baseline() -> dict:
    ...
    if (payload.get("$schema") != "lineboss/bodyshop-support-kit-native-v002-unreal-import-baseline/v3"
...
def main() -> None:
    ...
    evidence = {
        "$schema": "lineboss/audit/bodyshop-support-kit-native-v002-fresh-load-validation/v3",
        "generated_utc": now(),
    ...
    try:
        ...
        if (imported.get("$schema") != "lineboss/audit/bodyshop-support-kit-native-v002-unreal-import/v3"
        ...
        evidence.update({
            "status": (
                ...
                "SUPPORT_KIT_NATIVE_V002_LANE_V003"
            ),
        ...
        unreal.log("LINE_BOSS_BODYSHOP_SUPPORT_KIT_NATIVE_V002_LANE_V003_FRESH_LOAD_VALIDATION_PASS")
        print(json.dumps(evidence, indent=2))
        unreal.SystemLibrary.quit_editor()
    except Exception as error:
        record = dict(evidence)
        record.update({
            "status": "FAIL_CLOSED__BODYSHOP_SUPPORT_KIT_NATIVE_V002_LANE_V003_FRESH_LOAD_VALIDATION",
            "error": str(error),
            ...
            "recovery": "Preserve the importer/validator evidence and packages; do not rerun lane v003.",
        })
        failure_receipt.write_text(json.dumps(record, indent=2) + "\n", encoding="utf-8")
        unreal.log_error("LINE_BOSS_BODYSHOP_SUPPORT_KIT_NATIVE_V002_LANE_V003_VALIDATION_FAIL: " + str(error))
