"""Prepare isolated PR-004 carry-context v114 from retained v113."""
...
MAP = "/Game/LineBoss/Maps/LB_PressShop_PR004CarryContextCandidate_v114"
OUT = Path(unreal.Paths.project_saved_dir()) / "Audits/press_shop_pr004_carry_context_prepare_v114.json"
...
OUT.write_text(json.dumps({
    "$schema": "cairnwell/audit/press-shop-pr004-carry-context-prepare-v114/v1",
...
unreal.log(f"CAIRNWELL_PR004_CARRY_CONTEXT_V114_PREPARE_PASS created={created}")
