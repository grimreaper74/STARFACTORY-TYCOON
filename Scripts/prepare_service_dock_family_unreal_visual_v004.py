"""Create the fresh isolated service-dock visual v004 map without loading it."""
import unreal

SOURCE = "/Game/LineBoss/Developer/Validation/LB_ServiceDockFamilyIntake_v003"
TARGET = "/Game/LineBoss/Developer/Validation/LB_ServiceDockFamilyVisual_v004"
...
unreal.log("LINE_BOSS_SERVICE_DOCK_VISUAL_V004_PREPARE_PASS")
