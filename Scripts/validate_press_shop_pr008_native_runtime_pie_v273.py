"""Run the retained PR008 native runtime gate on exact whole-shop v273."""
from pathlib import Path
source = Path(__file__).with_name("validate_press_shop_pr008_native_runtime_pie_v213.py")
